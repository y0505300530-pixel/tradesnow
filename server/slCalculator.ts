...
// default `minRValuePct`. The GATE is flag-gated (minRValuePctEnabled) in the executor;
// this constant is the shared default (see server/minRValueGate.ts).
export const MIN_R_VALUE_PCT = 0.015; // 1.5%
